...
import { KKClubProjects } from './ClubProjects.type';
...
import style from './ClubProjects.css';
...
export class ClubProjects extends KKWebComponent implements KKClubProjects {
  static TAG = `kk-club-projects`;
...
customElements.define(ClubProjects.TAG, ClubProjects);
